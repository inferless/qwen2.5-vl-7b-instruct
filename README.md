...
- You can expect an average latency of `5.83 seconds` for image and	`22.25 seconds` for video with generating max tokens of `256`. This setup has an average cold start time of `38.17 seconds`.
